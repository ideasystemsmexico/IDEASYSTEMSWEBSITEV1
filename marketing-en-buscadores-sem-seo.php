			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">MARKETING EN
						</h5>
                        ...
                        El marketing en buscadores incluye la optimización para motores de búsqueda (SEO) y la publicidad en buscadores (SEM). 
                        Ambas estrategias son cruciales para mejorar la visibilidad y atraer tráfico cualificado a su sitio web.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Mayor visibilidad: </strong>Mejora la posición en los resultados de búsqueda.</li>
                            <li style="margin-bottom: 10px;"><strong>Tráfico cualificado: </strong>Atrae a usuarios interesados en sus productos o servicios.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora continua: </strong>Permite ajustes y optimizaciones basadas en datos de rendimiento.</li>
                        </ul>
                    </div>
