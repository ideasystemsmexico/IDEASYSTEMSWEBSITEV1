			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">IDENTIDAD VISUAL DE
						</h5>
                        ...
                        La identidad visual de la marca incluye todos los elementos gráficos y 
                        visuales que representan a la empresa, como colores, tipografía y diseño gráfico.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Consistencia Visual: </strong>Asegura una presentación visual uniforme en todos los canales de comunicación.</li>
                            <li style="margin-bottom: 10px;"><strong>Fortalece la Marca: </strong>Refuerza el mensaje y la personalidad de la marca a través de elementos visuales coherentes.</li>
                            <li style="margin-bottom: 10px;"><strong>Atractivo Visual: </strong>Captura la atención del público y mejora la experiencia del usuario.</li>
                        </ul>
                    </div>
