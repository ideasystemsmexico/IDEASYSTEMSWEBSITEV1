			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un sistema de gestión de marketing centraliza y automatiza todas sus actividades de marketing, desde la planificación y ejecución de campañas hasta el análisis de resultados. 
                        Esto es esencial para maximizar el retorno de inversión en marketing y mejorar la efectividad de sus esfuerzos.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Automatización de Campañas: </strong>Simplifica la creación, ejecución y seguimiento de campañas de marketing.</li>
                            <li style="margin-bottom: 10px;"><strong>Segmentación Efectiva: </strong>Permite segmentar su audiencia y personalizar las campañas.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Proporciona insights detallados sobre el rendimiento de las campañas y el comportamiento de los clientes.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora en el ROI: </strong>Optimiza los recursos y maximiza el retorno de inversión en marketing.</li>
                        </ul>
                    </div>
