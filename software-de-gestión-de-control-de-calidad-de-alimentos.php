			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SOFTWARE DE GESTIÓN DE CONTROL DE 
						</h5>
                        ...
                        El software de gestión de control de calidad de alimentos es una herramienta diseñada para asegurar la calidad y seguridad de los productos alimentarios. 
                        Facilita la gestión de procesos de calidad, auditorías y cumplimiento normativo.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Seguridad Alimentaria: </strong>Asegura el cumplimiento de los estándares de seguridad alimentaria mediante la gestión eficiente de procesos de calidad.</li>
                            <li style="margin-bottom: 10px;"><strong>Cumplimiento Normativo: </strong>Facilita el cumplimiento de regulaciones y normativas de calidad alimentaria.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora de la Calidad: </strong>Ayuda a identificar y corregir problemas de calidad, mejorando la satisfacción del cliente.</li>
                            <li style="margin-bottom: 10px;"><strong>Eficiencia Operativa: </strong>Optimiza los procesos de control de calidad, reduciendo costos y tiempos.</li>
                        </ul>
                    </div>
