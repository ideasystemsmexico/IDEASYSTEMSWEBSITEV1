			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El software de gestión de proyectos de construcción es una herramienta esencial para la planificación, seguimiento y control de proyectos de construcción. 
                        Facilita la colaboración entre equipos, la gestión de recursos y la supervisión de todas las fases del proyecto.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Eficiencia en la Planificación: </strong>Mejora la planificación y coordinación de todas las actividades del proyecto.</li>
                            <li style="margin-bottom: 10px;"><strong>Seguimiento en Tiempo Real: </strong>Permite el seguimiento y control de todas las fases del proyecto en tiempo real.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Recursos: </strong>Optimiza la asignación y uso de recursos, reduciendo costos y tiempo.</li>
                            <li style="margin-bottom: 10px;"><strong>Colaboración Efectiva: </strong>Facilita la comunicación y colaboración entre todos los miembros del equipo.</li>
                        </ul>
                    </div>
