			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        La publicidad en línea abarca una variedad de formatos, incluyendo anuncios de búsqueda, display, video y redes sociales. 
                        Es una forma flexible y altamente segmentable de llegar a los clientes en el entorno digital.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Alcance global: </strong>Permite llegar a una audiencia global de manera eficiente.</li>
                            <li style="margin-bottom: 10px;"><strong>Segmentación precisa: </strong>Ofrece opciones de segmentación detalladas para alcanzar a los públicos más relevantes.</li>
                            <li style="margin-bottom: 10px;"><strong>Medición y análisis: </strong>Proporciona datos detallados para medir el rendimiento y optimizar las campañas.</li>
                        </ul>
                    </div>
