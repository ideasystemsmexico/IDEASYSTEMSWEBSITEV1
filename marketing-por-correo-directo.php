			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">MARKETING POR
						</h5>
                        ...
                        El marketing por correo directo implica el envío de materiales promocionales, como catálogos y folletos, directamente a los consumidores.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Segmentación Precisa: </strong>Permite dirigirse a segmentos específicos de la audiencia con mensajes personalizados.</li>
                            <li style="margin-bottom: 10px;"><strong>Tangible: </strong>Los materiales impresos son tangibles y pueden dejar una impresión duradera en los destinatarios.</li>
                            <li style="margin-bottom: 10px;"><strong>Medición de Respuesta: </strong>Facilita la medición de la tasa de respuesta y el retorno de inversión.</li>
                        </ul>
                    </div>
