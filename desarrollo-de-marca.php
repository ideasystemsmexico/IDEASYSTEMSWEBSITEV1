			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">DESARROLLO DE
						</h5>
                        ...
                        El desarrollo de marca es crucial para construir una identidad fuerte y reconocible que resuene con su audiencia y diferencie su empresa de la competencia.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Fortalece la identidad: </strong>Construye una identidad de marca sólida y coherente.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora el reconocimiento: </strong>Aumenta el reconocimiento y la memoria de la marca.</li>
                            <li style="margin-bottom: 10px;"><strong>Fomenta la lealtad: </strong>Una marca fuerte genera lealtad y confianza entre los clientes.</li>
                        </ul>
                    </div>
