			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El análisis de datos implica la revisión y la interpretación de datos recopilados para extraer conclusiones y tomar decisiones informadas.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Toma de Decisiones Informadas: </strong>Facilita decisiones basadas en datos precisos y análisis detallados.</li>
                            <li style="margin-bottom: 10px;"><strong>Identificación de Tendencias: </strong>Ayuda a identificar tendencias y patrones en el comportamiento del consumidor.</li>
                            <li style="margin-bottom: 10px;"><strong>Optimización de Estrategias: </strong>Permite optimizar las estrategias de marketing y negocio basándose en insights derivados de los datos.</li>
                        </ul>
                    </div>
