			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        La estrategia de contenido define los objetivos, el tipo de contenido a crear y los canales de distribución.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Claridad de Objetivos: </strong>Define objetivos claros y alineados con la estrategia general de marketing.</li>
                            <li style="margin-bottom: 10px;"><strong>Planificación Efectiva: </strong>Facilita la planificación y creación de contenido coherente y relevante.</li>
                            <li style="margin-bottom: 10px;"><strong>Medición de Resultados: </strong>Permite evaluar la efectividad del contenido y ajustar la estrategia según los resultados.</li>
                        </ul>
                    </div>
