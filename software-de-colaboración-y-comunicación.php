			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de colaboración y comunicación centraliza y facilita la comunicación y colaboración entre los miembros del equipo, mejorando la eficiencia operativa y la satisfacción del empleado. 
                        Es esencial para mantener la competitividad y asegurar la calidad en la entrega de proyectos.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Mejora en la Comunicación: </strong>Facilita la comunicación entre los miembros del equipo.</li>
                            <li style="margin-bottom: 10px;"><strong>Colaboración Eficiente: </strong>Proporciona herramientas para la colaboración en tiempo real.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Tareas y Proyectos: </strong>Facilita la gestión y seguimiento de tareas y proyectos.</li>
