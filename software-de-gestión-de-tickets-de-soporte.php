			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SOFTWARE DE GESTION DE 
						</h5>
                        ...
                        Un software de gestión de tickets de soporte centraliza y gestiona todas las solicitudes de soporte de los clientes, mejorando la eficiencia y la calidad del servicio al cliente. 
                        Es esencial para mantener la satisfacción y lealtad del cliente.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Centralización de Solicitudes de Soporte: </strong>Facilita la gestión de todas las solicitudes de soporte en un solo lugar.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora en la Respuesta al Cliente: </strong>Proporciona herramientas para responder de manera rápida y eficiente a las consultas y problemas de los clientes.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis de Datos del Cliente: </strong>Proporciona insights sobre el comportamiento y las necesidades del cliente.</li>
                            <li style="margin-bottom: 10px;"><strong>Automatización de Tareas Repetitivas: </strong>Reduce el tiempo y el esfuerzo en tareas repetitivas y administrativas.</li>
                        </ul>
                    </div>
