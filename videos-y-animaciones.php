			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">VIDEOS Y
						</h5>
                        ...
                        Los videos y animaciones son formatos de contenido visual y dinámico que pueden comunicar mensajes de manera efectiva y atractiva.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Engagement Alto: </strong>Atraen y mantienen la atención del público más que otros formatos de contenido.</li>
                            <li style="margin-bottom: 10px;"><strong>Versatilidad: </strong>Pueden utilizarse en diversas plataformas y para múltiples propósitos, desde educación hasta entretenimiento.</li>
                            <li style="margin-bottom: 10px;"><strong>Conversión: </strong>Los videos son altamente efectivos para generar conversiones y ventas.</li>
                        </ul>
                    </div>
