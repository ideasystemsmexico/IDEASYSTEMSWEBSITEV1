			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">PUBLICIDAD EXTERIOR
						</h5>
						<h1 class="font-weight-bold text-12 line-height-2 mb-3"
							...
							VALLAS PUBLICITARIAS Y TRANSPORTE PUBLICO
						</h1>
                        ...
                        La publicidad exterior incluye anuncios en vallas publicitarias, paradas de autobús, estaciones de metro y otros espacios públicos. 
                        Es una forma visible y omnipresente de captar la atención de los transeúntes.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Visibilidad constante: </strong>Los anuncios exteriores están visibles las 24 horas del día.</li>
                            <li style="margin-bottom: 10px;"><strong>Alcance masivo: </strong>Llega a una gran cantidad de personas en áreas de alto tráfico.</li>
                            <li style="margin-bottom: 10px;"><strong>Impacto visual: </strong>Utiliza gráficos grandes y llamativos para captar la atención.</li>
                        </ul>
                    </div>
