			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">ANALITICA Y SEGUIMIENTO DE
						</h5>
                        ...
                        El análisis y seguimiento de resultados son esenciales para medir el éxito de las campañas de marketing y tomar decisiones informadas.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Medición precisa: </strong>Proporciona datos detallados sobre el rendimiento de las campañas.</li>
                            <li style="margin-bottom: 10px;"><strong>Optimización continua: </strong>Permite ajustar y mejorar las estrategias basadas en datos.</li>
                            <li style="margin-bottom: 10px;"><strong>Justificación del ROI: </strong>Ayuda a demostrar el retorno de inversión de las actividades de marketing.</li>
                        </ul>
                    </div>
