			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">GESTIÓN DE
						</h5>
                        ...
                        La gestión de redes sociales es fundamental para interactuar con su audiencia, construir comunidad y promover su marca en plataformas populares.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Incrementa la interacción: </strong>Facilita la comunicación directa con los clientes y seguidores.</li>
                            <li style="margin-bottom: 10px;"><strong>Aumenta la visibilidad: </strong>Mejora la visibilidad y el alcance de la marca.</li>
                            <li style="margin-bottom: 10px;"><strong>Fomenta la lealtad: </strong>Construye relaciones sólidas y leales con la audiencia.</li>
                        </ul>
                    </div>
