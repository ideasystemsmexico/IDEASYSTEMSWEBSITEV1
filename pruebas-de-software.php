			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">PRUEBAS DE
						</h5>
                        ...
                        ¿Por qué debería adquirir este servicio? Las pruebas de software son fundamentales para asegurar la calidad y fiabilidad de sus aplicaciones. 
                        Detectar y corregir problemas antes del lanzamiento puede ahorrar tiempo y costos significativos a largo plazo.
						<br>
                        Nuestros servicios de pruebas de software abarcan pruebas funcionales, de rendimiento, seguridad, y usabilidad. 
                        Utilizamos herramientas y metodologías avanzadas para asegurar que su software cumpla con los más altos estándares de calidad.
						</p>
