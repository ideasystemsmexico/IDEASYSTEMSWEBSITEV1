			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El software de gestión de vehículos eléctricos es una herramienta diseñada para optimizar la operación y el mantenimiento de flotas de vehículos eléctricos. 
                        Facilita la planificación de rutas, gestión de carga y mantenimiento de vehículos.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Eficiencia Operativa: </strong>Mejora la planificación y gestión de rutas, optimizando el uso de vehículos eléctricos.</li>
                            <li style="margin-bottom: 10px;"><strong>Mantenimiento Preventivo: </strong>Facilita la gestión del mantenimiento, reduciendo el tiempo de inactividad y los costos de reparación.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Carga: </strong>Optimiza la gestión de la carga de los vehículos, asegurando una operación continua y eficiente.</li>
                            <li style="margin-bottom: 10px;"><strong>Sostenibilidad: </strong>Ayuda a reducir la huella de carbono y a cumplir con los objetivos de sostenibilidad mediante la gestión eficiente de vehículos eléctricos.</li>
                        </ul>
                    </div>
