			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">
						</h5>
                        ...
                        El producto es el núcleo del marketing mix y se refiere a los bienes o servicios que su empresa ofrece. 
                        Un producto bien desarrollado satisface las necesidades y expectativas de los clientes, diferenciándose de la competencia.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Satisfacción del cliente: </strong>Ofrecer productos que satisfacen las necesidades del cliente mejora la lealtad.</li>
                            <li style="margin-bottom: 10px;"><strong>Diferenciación: </strong>Un producto único y de alta calidad se destaca en el mercado.</li>
                            <li style="margin-bottom: 10px;"><strong>Valor añadido: </strong>Productos innovadores y bien diseñados proporcionan un valor significativo al cliente.</li>
                        </ul>
                    </div>
