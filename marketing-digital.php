			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El marketing digital abarca diversas estrategias y canales para promocionar su marca en el entorno en línea, llegando a un público amplio y específico.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            ...
                            <li style="margin-bottom: 10px;"><strong>Medición precisa: </strong>Proporciona herramientas para medir y analizar el rendimiento de las campañas.</li>
                            <li style="margin-bottom: 10px;"><strong>Segmentación efectiva: </strong>Permite segmentar y personalizar los mensajes para diferentes audiencias.</li>
                        </ul>
                    </div>
