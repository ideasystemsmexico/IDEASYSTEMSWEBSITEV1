			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El marketing móvil abarca estrategias para llegar a los consumidores a través de dispositivos móviles, como aplicaciones, mensajes SMS y anuncios móviles.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Acceso Directo: </strong>Llega a los consumidores en cualquier momento y lugar a través de sus dispositivos móviles.</li>
                            <li style="margin-bottom: 10px;"><strong>Interactividad: </strong>Ofrece experiencias interactivas y personalizadas a los usuarios móviles.</li>
                            <li style="margin-bottom: 10px;"><strong>Alto Engagement: </strong>Los dispositivos móviles suelen tener tasas de apertura y respuesta más altas que otros canales.</li>
                        </ul>
                    </div>
