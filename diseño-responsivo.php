			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El diseño responsivo asegura que su sitio web se vea y funcione correctamente en todos los dispositivos, 
                        ya sean computadoras de escritorio, tablets o teléfonos móviles.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Aumenta el alcance: </strong>Llega a usuarios en diversos dispositivos y plataformas.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora el SEO: </strong>Google favorece los sitios web optimizados para móviles en los resultados de búsqueda.</li>
                            <li style="margin-bottom: 10px;"><strong>Ofrece una experiencia consistente: </strong>Proporciona una experiencia de usuario uniforme sin importar el dispositivo.</li>
                        </ul>
                    </div>
