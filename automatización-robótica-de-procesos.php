			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">AUTOMATIZACIÓN ROBOTICA DE
						</h5>
                        ...
                        ¿Por qué debería adquirir este servicio? La automatización robótica de procesos permite automatizar tareas repetitivas y basadas en reglas, mejorando la eficiencia y reduciendo errores humanos.
						<br>
                        Ofrecemos servicios de implementación de RPA que incluyen la identificación de procesos automatizables, 
                        diseño de bots y monitoreo continuo. Nos aseguramos de que sus procesos sean automatizados de manera eficiente y efectiva.
                        </p>
					</div>
