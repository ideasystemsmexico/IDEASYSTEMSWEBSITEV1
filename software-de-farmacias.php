			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión para farmacias permite una gestión eficiente y centralizada de todas las actividades de la farmacia, mejorando la eficiencia y la calidad del servicio al cliente. 
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Gestión de Inventarios: </strong>Facilita la gestión y control del inventario de medicamentos.</li>
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos: </strong>Reduce errores y aumenta la eficiencia.</li>
                            <li style="margin-bottom: 10px;"><strong>Cumplimiento Normativo: </strong>Asegura que su farmacia cumpla con las regulaciones vigentes.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Proporciona insights sobre el rendimiento de la farmacia y las preferencias de los clientes.</li>
                        </ul>
                    </div>
