			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El email marketing utiliza correos electrónicos personalizados para comunicarse directamente con clientes actuales y potenciales, promoviendo productos y servicios.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Personalización: </strong>Permite enviar mensajes personalizados y segmentados según las preferencias y el comportamiento del usuario.</li>
                            <li style="margin-bottom: 10px;"><strong>Coste-Efectividad: </strong>Es una de las estrategias de marketing digital más económicas.</li>
                            <li style="margin-bottom: 10px;"><strong>Medición y Análisis: </strong>Proporciona métricas detalladas como tasas de apertura y clics para evaluar la efectividad de las campañas.</li>
                        </ul>
                    </div>
