			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">INVESTIGACIÓN DE
						</h5>
                        ...
                        La investigación de mercado proporciona insights valiosos sobre su audiencia, competidores y mercado, permitiendo tomar decisiones informadas y estratégicas.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Comprensión profunda: </strong>Ofrece una comprensión detallada del mercado y los consumidores.</li>
                            <li style="margin-bottom: 10px;"><strong>Identificación de oportunidades: </strong>Ayuda a descubrir oportunidades de crecimiento y mejora.</li>
                            <li style="margin-bottom: 10px;"><strong>Reducción de riesgos: </strong>Minimiza los riesgos al basar las decisiones en datos concretos.</li>
                        </ul>
                    </div>
