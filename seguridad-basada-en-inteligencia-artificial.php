			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SEGURIDAD
						</h5>
                        ...
                        ¿Por qué debería adquirir este servicio? La seguridad basada en IA permite detectar y responder a amenazas de manera más rápida y precisa,
                        mejorando la protección de sus sistemas y datos.
						<br>
                        Ofrecemos servicios de implementación de soluciones de seguridad basadas en IA que incluyen la detección de anomalías, prevención de fraudes y respuesta a incidentes. 
                        Utilizamos técnicas avanzadas para asegurar que sus sistemas sean seguros y protegidos.
                        </p>
					</div>
