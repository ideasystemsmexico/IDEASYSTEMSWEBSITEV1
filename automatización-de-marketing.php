			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">AUTOMATIZACIÓN DE 
						</h5>
                        ...
                        La automatización de marketing utiliza software para automatizar tareas repetitivas, mejorar la eficiencia y personalizar la experiencia del cliente.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Aumenta la eficiencia: </strong>Automatiza tareas repetitivas y ahorra tiempo.</li>
                            <li style="margin-bottom: 10px;"><strong>Personaliza la experiencia: </strong>Ofrece experiencias personalizadas a los clientes.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora la medición: </strong>Proporciona datos y análisis detallados sobre el rendimiento de las campañas.</li>
                        </ul>
                    </div>
