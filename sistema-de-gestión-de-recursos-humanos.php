			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SISTEMAS DE GESTIÓN DE
						</h5>
                        ...
                        Un sistema de recursos humanos centraliza y automatiza todas las actividades relacionadas con la gestión del personal, desde la contratación hasta la gestión del desempeño. 
                        Es esencial para mejorar la eficiencia y la satisfacción del empleado.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos de RRHH: </strong>Reduce errores y aumenta la eficiencia.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión del Desempeño: </strong>Facilita la evaluación y gestión del desempeño del empleado.</li>
                            <li style="margin-bottom: 10px;"><strong>Cumplimiento Normativo: </strong>Asegura que su empresa cumpla con las regulaciones laborales vigentes.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora en la Satisfacción del Empleado: </strong>Proporciona herramientas para mejorar la experiencia del empleado y la retención del talento.</li>
                        </ul>
                    </div>
