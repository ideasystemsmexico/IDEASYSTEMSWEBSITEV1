			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un CRM permite gestionar de manera efectiva las relaciones con sus clientes, mejorando la satisfacción y lealtad del cliente. 
                        Facilita el seguimiento de interacciones, ventas y soporte al cliente, optimizando todas las etapas del ciclo de vida del cliente.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Mejora en la Satisfacción del Cliente:</strong> Personaliza la interacción con cada cliente y mejora la atención al cliente.</li>
                            <li style="margin-bottom: 10px;"><strong>Aumento de Ventas:</strong> Identifica oportunidades de venta y mejora la gestión del pipeline de ventas.</li>
                            <li style="margin-bottom: 10px;"><strong>Eficiencia en el Marketing:</strong> Segmenta su base de datos de clientes y lanza campañas de marketing más efectivas.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes:</strong> Obtenga insights detallados sobre el comportamiento y preferencias de sus clientes.</li>
                        </ul>
                    </div>
