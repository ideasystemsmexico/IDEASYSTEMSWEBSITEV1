			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de fidelización al cliente permite gestionar y mejorar las relaciones con sus clientes, aumentando la lealtad y la retención de clientes. 
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Gestión de Programas de Fidelización: </strong>Facilita la creación y gestión de programas de fidelización.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora en la Retención de Clientes: </strong>Proporciona herramientas para mejorar la lealtad y la retención de clientes.</li>
                            ...
                            <li style="margin-bottom: 10px;"><strong>Automatización de Tareas: </strong>Reduce errores y aumenta la eficiencia operativa</li>
                        </ul>
                    </div>
