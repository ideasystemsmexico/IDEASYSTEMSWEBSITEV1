			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El precio es un factor crítico que influye en la percepción del valor de su producto y en la decisión de compra del cliente. 
                        Establecer una estrategia de precios adecuada es esencial para maximizar las ventas y los márgenes de beneficio.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Competitividad: </strong>Un precio adecuado puede mejorar la competitividad en el mercado.</li>
                            <li style="margin-bottom: 10px;"><strong>Percepción de valor: </strong>El precio correcto refleja el valor y la calidad del producto.</li>
                            <li style="margin-bottom: 10px;"><strong>Maximización de ingresos: </strong>Una estrategia de precios efectiva puede aumentar los ingresos y la rentabilidad.</li>
                        </ul>
                    </div>
