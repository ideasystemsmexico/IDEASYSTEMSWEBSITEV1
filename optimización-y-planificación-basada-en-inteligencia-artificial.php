			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">OPTIMIZACIÓN Y PLANIFICACION
						</h5>
                        ...
                        ¿Por qué debería adquirir este servicio? La optimización y planificación basada en IA permite mejorar la eficiencia operativa y 
                        la toma de decisiones estratégicas mediante el uso de algoritmos avanzados y técnicas de machine learning.
						<br>
                        Proveemos servicios de desarrollo de soluciones de optimización y planificación que incluyen la creación de modelos predictivos, simulación de escenarios y optimización de recursos. 
                        Nuestro objetivo es ayudarlo a tomar decisiones informadas y estratégicas.
                        </p>
					</div>
