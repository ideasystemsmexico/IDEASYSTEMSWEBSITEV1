			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SOFTWARE DE PROYECTOS DE
						</h5>
                        ...
                        Un software de gestión para proyectos de construcción centraliza y automatiza todas las actividades relacionadas con la planificación, ejecución y seguimiento de proyectos de construcción, mejorando la eficiencia y asegurando la calidad en la entrega de proyectos. 
                        Es esencial para mantener la competitividad y cumplir con los plazos y presupuestos establecidos.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Planificación y Programación Eficiente: </strong>Mejora la planificación y programación de tareas y recursos.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Recursos y Materiales: </strong>Optimiza la asignación y uso de recursos y materiales.</li>
                            <li style="margin-bottom: 10px;"><strong>Seguimiento de Progreso: </strong>Permite monitorear el progreso de los proyectos en tiempo real.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora en la Comunicación y Colaboración: </strong>Facilita la comunicación y colaboración entre los miembros del equipo y los stakeholders.</li>
                        </ul>
                    </div>
