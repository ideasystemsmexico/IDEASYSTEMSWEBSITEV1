			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El marketing de afiliados utiliza terceros (afiliados) para promover productos y servicios, quienes ganan una comisión por cada venta o conversión generada.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Ampliación del Alcance: </strong>Los afiliados pueden llegar a nuevas audiencias y mercados.</li>
                            <li style="margin-bottom: 10px;"><strong>Riesgo Bajo: </strong>Pago basado en resultados, lo que minimiza el riesgo financiero.</li>
                            <li style="margin-bottom: 10px;"><strong>Medición Precisa: </strong>Fácil seguimiento y medición del rendimiento de los afiliados.</li>
                        </ul>
                    </div>
