			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un sistema de gestión de producción optimiza y automatiza los procesos de producción, mejorando la eficiencia y reduciendo los costos de producción. 
                        Es esencial para mantener la competitividad y la calidad en la producción de bienes.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos de Producción: </strong>Reduce errores y aumenta la eficiencia.</li>
                            <li style="margin-bottom: 10px;"><strong>Optimización de Recursos: </strong>Mejora la utilización de recursos y reduce los desperdicios.</li>
                            <li style="margin-bottom: 10px;"><strong>Control de Calidad: </strong>Asegura que los productos cumplan con los estándares de calidad.</li>
                            <li style="margin-bottom: 10px;"><strong>Seguimiento de Producción en Tiempo Real: </strong>Proporciona visibilidad y control sobre el proceso de producción.</li>
                        </ul>
                    </div>
