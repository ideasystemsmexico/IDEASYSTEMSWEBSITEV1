			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Las ventas directas implican la venta de productos o servicios directamente al consumidor, sin intermediarios.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Relación Directa con el Cliente: </strong>Facilita la construcción de relaciones personales con los clientes.</li>
                            <li style="margin-bottom: 10px;"><strong>Feedback Inmediato: </strong>Proporciona retroalimentación directa del cliente sobre el producto o servicio.</li>
                            <li style="margin-bottom: 10px;"><strong>Control del Proceso de Venta: </strong>Permite un control total sobre el proceso de venta y la experiencia del cliente.</li>
                        </ul>
                    </div>
