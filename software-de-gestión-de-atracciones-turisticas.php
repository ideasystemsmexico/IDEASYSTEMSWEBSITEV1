			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El software de gestión de atracciones turísticas es una herramienta diseñada para optimizar la operación y 
                        administración de parques temáticos, museos, y otras atracciones turísticas. Facilita la gestión de boletos, reservas, visitantes y eventos.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Eficiencia Operativa: Mejora la gestión de boletos, reservas y visitantes, optimizando el flujo de operaciones.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora la Experiencia del Visitante: Facilita una experiencia de visitante más fluida y agradable mediante la gestión eficiente de servicios.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: Proporciona datos y reportes detallados sobre el desempeño de la atracción, permitiendo tomar decisiones informadas.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Eventos: Facilita la planificación y gestión de eventos, mejorando la oferta de actividades y la satisfacción del visitante.</li>
                        </ul>
                    </div>
