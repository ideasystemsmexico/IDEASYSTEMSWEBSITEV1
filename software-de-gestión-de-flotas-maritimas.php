			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SOFTWARE DE GESTIÓN DE
						</h5>
                        ...
                        El software de gestión de flotas marítimas es una herramienta diseñada para optimizar la operación y el mantenimiento de embarcaciones y flotas marítimas. 
                        Este software facilita la planificación, seguimiento y gestión de todas las actividades relacionadas con las flotas.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Eficiencia Operativa: </strong>Mejora la planificación y seguimiento de las actividades de la flota, optimizando el uso de recursos.</li>
                            <li style="margin-bottom: 10px;"><strong>Mantenimiento Preventivo: </strong>Facilita la gestión del mantenimiento de las embarcaciones, reduciendo el tiempo de inactividad y los costos de reparación.</li>
                            <li style="margin-bottom: 10px;"><strong>Cumplimiento Normativo: </strong>Ayuda a cumplir con las regulaciones y normativas marítimas mediante el seguimiento y registro de todas las actividades.</li>
                            <li style="margin-bottom: 10px;"><strong>Seguridad: </strong>Mejora la seguridad de las operaciones mediante la monitorización en tiempo real y la gestión de riesgos.</li>
                        </ul>
                    </div>
