			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SOFTWARE DE ANÁLISIS
						</h5>
                        ...
                        El software de análisis de riesgo financiero es una herramienta que permite a las empresas evaluar y gestionar los riesgos asociados con sus operaciones financieras. 
                        Este tipo de software ayuda a identificar, analizar y mitigar los riesgos financieros, mejorando la toma de decisiones y la estabilidad financiera.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Identificación de Riesgos: </strong>Permite identificar y evaluar los riesgos financieros de manera proactiva.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora la Toma de Decisiones: </strong>Facilita la toma de decisiones informadas mediante el análisis de datos y escenarios.</li>
                            <li style="margin-bottom: 10px;"><strong>Mitigación de Riesgos: </strong>Ayuda a desarrollar estrategias efectivas para mitigar los riesgos financieros.</li>
                            <li style="margin-bottom: 10px;"><strong>Cumplimiento Normativo: </strong>Asegura el cumplimiento de las regulaciones y normativas financieras mediante el seguimiento y reporte de riesgos.</li>
                        </ul>
                    </div>
