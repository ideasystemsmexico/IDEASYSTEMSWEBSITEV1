			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">USABILIDAD DEL
						</h5>
                        ...
                        La usabilidad del sitio web se refiere a la facilidad con la que los usuarios pueden navegar y utilizar su sitio web para lograr sus objetivos.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Aumenta la eficiencia: </strong>Los usuarios pueden encontrar y usar la información y las funciones del sitio de manera rápida y sencilla.</li>
                            <li style="margin-bottom: 10px;"><strong>Reduce los errores del usuario: </strong>Un diseño usable minimiza la posibilidad de errores.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora la satisfacción del usuario: </strong>Una buena usabilidad se traduce en una experiencia más agradable y eficiente.</li>
                        </ul>
                    </div>
