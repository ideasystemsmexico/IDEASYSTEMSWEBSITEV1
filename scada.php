			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SUPERVISORY CONTROL AND ACQUISITION
						</h5>
                        ...
                        Un sistema SCADA permite la supervisión y control en tiempo real de procesos industriales, mejorando la eficiencia y la seguridad operativa. 
						Es esencial para mantener la continuidad y la calidad en las operaciones industriales.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Monitoreo en Tiempo Real: </strong>Proporciona visibilidad y control sobre los procesos industriales en tiempo real.</li>
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos: </strong>Mejora la eficiencia y reduce los errores.</li>
                            ...
                            <li style="margin-bottom: 10px;"><strong>Análisis de Datos: </strong>Proporciona insights sobre el rendimiento de los procesos y permite la toma de decisiones informadas.</li>
                        </ul>
                    </div>
