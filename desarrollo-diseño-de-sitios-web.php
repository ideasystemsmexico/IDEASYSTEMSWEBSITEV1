			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">DESARROLLO Y DISEÑO DE
						</h5>
                        ...
                        Desarrollar un sitio web funcional y atractivo es esencial para proporcionar una experiencia de usuario positiva y mejorar la presencia en línea de su marca.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Mejora la presencia en línea: </strong>Proporciona una plataforma profesional y accesible para su marca.</li>
                            <li style="margin-bottom: 10px;"><strong>Facilita la interacción: </strong>Permite a los usuarios interactuar y obtener información fácilmente.</li>
                            <li style="margin-bottom: 10px;"><strong>Incrementa las conversiones: </strong>Un sitio bien diseñado puede aumentar las tasas de conversión.</li>
                        </ul>
                    </div>
