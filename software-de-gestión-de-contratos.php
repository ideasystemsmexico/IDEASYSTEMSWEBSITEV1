			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión de contratos centraliza y automatiza todas las actividades relacionadas con la gestión de contratos, mejorando la eficiencia y asegurando el cumplimiento de los acuerdos. 
                        Es esencial para mantener la competitividad y minimizar los riesgos.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            ...
                            <li style="margin-bottom: 10px;"><strong>Cumplimiento Normativo: </strong>Asegura que su empresa cumpla con los términos y condiciones de los contratos.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Renovaciones: </strong>Facilita la gestión y renovación de contratos.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Proporciona insights sobre el rendimiento y estado de los contratos.</li>
                        </ul>
                    </div>
