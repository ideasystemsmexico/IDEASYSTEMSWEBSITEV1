			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de seguridad y vigilancia permite una gestión eficiente y centralizada de todas las actividades relacionadas con la seguridad y vigilancia, mejorando la seguridad operativa y reduciendo los riesgos. 
                        Es esencial para mantener la competitividad y asegurar la protección de las instalaciones y el personal.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Monitoreo en Tiempo Real: </strong>Proporciona visibilidad y control sobre todas las actividades de seguridad y vigilancia en tiempo real.</li>
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos: </strong>Reduce errores y aumenta la eficiencia operativa.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Alarmas y Eventos: </strong>Facilita la detección y gestión de incidentes y problemas.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Proporciona insights sobre el rendimiento de las actividades de seguridad y vigilancia.</li>
                        </ul>
                    </div>
