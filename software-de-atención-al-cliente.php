			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de atención al cliente centraliza y gestiona todas las interacciones con los clientes, mejorando la eficiencia y la calidad del servicio al cliente. 
                        Es crucial para mantener la satisfacción y lealtad del cliente.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Centralización de Interacciones: </strong>Facilita la gestión de todas las interacciones con los clientes en un solo lugar.</li>
