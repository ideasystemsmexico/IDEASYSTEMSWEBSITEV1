			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">EXPERIENCIA DE 
						</h5>
                        ...
                        La experiencia de marca es la percepción y las emociones que los clientes tienen al interactuar con la empresa en todos los puntos de contacto.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Diferenciación Competitiva: </strong>Una experiencia de marca positiva puede diferenciar a la empresa de sus competidores.</li>
                            <li style="margin-bottom: 10px;"><strong>Lealtad del Cliente: </strong>Mejora la satisfacción y la fidelidad del cliente a través de experiencias memorables.</li>
                            <li style="margin-bottom: 10px;"><strong>Recomendaciones: </strong>Los clientes satisfechos son más propensos a recomendar la marca a otros.</li>
                        </ul>
                    </div>
