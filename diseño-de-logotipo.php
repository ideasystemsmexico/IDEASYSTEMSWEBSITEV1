			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El diseño de logotipo es la creación de un símbolo gráfico que representa a la empresa y sus valores.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Reconocimiento Inmediato: </strong>Un logotipo memorable facilita el reconocimiento instantáneo de la marca.</li>
                            <li style="margin-bottom: 10px;"><strong>Diferenciación: </strong>Ayuda a la marca a destacarse visualmente en un mercado competitivo.</li>
                            <li style="margin-bottom: 10px;"><strong>Profesionalismo: </strong>Transmite profesionalismo y seriedad, mejorando la percepción de la marca.</li>
                        </ul>
                    </div>
