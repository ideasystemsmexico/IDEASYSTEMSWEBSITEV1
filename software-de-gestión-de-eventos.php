			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión de eventos centraliza y automatiza todas las actividades relacionadas con la organización y gestión de eventos, mejorando la eficiencia operativa y la satisfacción del cliente. 
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            ...
                            <li style="margin-bottom: 10px;"><strong>Gestión de Eventos y Horarios:  </strong>Proporciona herramientas para gestionar y programar eventos y horarios.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Proporciona insights sobre la eficiencia y el rendimiento del equipo.</li>
                        </ul>
                    </div>
