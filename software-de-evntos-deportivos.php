			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión para eventos deportivos centraliza y automatiza todas las actividades relacionadas con la organización y gestión de eventos deportivos, mejorando la eficiencia operativa y la satisfacción del cliente. 
                        Es esencial para mantener la competitividad y proporcionar una experiencia excepcional al cliente.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Gestión de Inscripciones: </strong>Facilita la gestión de inscripciones y participantes.</li>
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos: </strong>Reduce errores y aumenta la eficiencia.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Clases y Horarios: </strong>Proporciona herramientas para gestionar y programar clases y horarios.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Proporciona insights sobre el rendimiento del gimnasio y las preferencias de los clientes.</li>
                        </ul>
                    </div>
