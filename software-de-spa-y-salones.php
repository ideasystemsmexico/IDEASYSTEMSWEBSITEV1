			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión para SPA y salones permite una gestión eficiente de citas, clientes y operaciones, mejorando la satisfacción del cliente y la eficiencia operativa. 
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Gestión de Citas: </strong>Facilita la programación y gestión de citas.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Clientes: </strong>Proporciona herramientas para gestionar y fidelizar a los clientes.</li>
                            <li style="margin-bottom: 10px;"><strong>Optimización de Operaciones: </strong>Mejora la eficiencia operativa y reduce los tiempos de espera.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Proporciona insights sobre el rendimiento del negocio y las preferencias de los clientes.</li>
                        </ul>
                    </div>
