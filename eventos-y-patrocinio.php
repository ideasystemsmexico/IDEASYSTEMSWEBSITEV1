			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">EVENTOS Y
						</h5>
                        ...
                        Organizar eventos y participar en patrocinios son estrategias efectivas para aumentar la visibilidad de su marca y conectar con su audiencia.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Aumenta la visibilidad: </strong>Promueve la marca a través de eventos y actividades patrocinadas.</li>
                            <li style="margin-bottom: 10px;"><strong>Fomenta la interacción: </strong>Permite una interacción directa con clientes y stakeholders.</li>
                            <li style="margin-bottom: 10px;"><strong>Genera lealtad: </strong>Los eventos y patrocinios pueden mejorar la percepción y lealtad hacia la marca.</li>
                        </ul>
                    </div>
