			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión de archivos digitales centraliza y facilita la gestión y acceso a documentos y archivos digitales, mejorando la eficiencia y asegurando la seguridad de la información. 
                        Es esencial para mantener la competitividad y asegurar la calidad en la gestión de documentos.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Centralización de Archivos: </strong>Facilita la gestión y acceso a documentos y archivos digitales en un solo lugar.</li>
                            <li style="margin-bottom: 10px;"><strong>Seguridad de la Información: </strong>Asegura la protección y privacidad de los documentos y archivos.</li>
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos: </strong>Reduce errores y aumenta la eficiencia operativa.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Proporciona insights sobre la gestión y el uso de documentos y archivos digitales.</li>
                        </ul>
                    </div>
