			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">ESTRATEGIA DE
						</h5>
                        ...
                        Desarrollar una estrategia de marketing sólida es fundamental para guiar todas las actividades de marketing y alcanzar los objetivos de negocio.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Dirección clara: </strong>Proporciona una hoja de ruta clara para todas las actividades de marketing.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora la coherencia: </strong>Asegura que todas las iniciativas de marketing estén alineadas con los objetivos de la empresa.</li>
                            <li style="margin-bottom: 10px;"><strong>Optimiza recursos: </strong>Permite una asignación eficiente de los recursos de marketing.</li>
                        </ul>
                    </div>
