			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">MARKETING DE 
						</h5>
                        ...
                        El marketing de contenidos se centra en crear y distribuir contenido valioso y relevante para atraer y retener a una audiencia claramente definida.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Atrae tráfico: </strong>Genera tráfico orgánico a través de contenido de calidad.</li>
                            <li style="margin-bottom: 10px;"><strong>Fomenta la confianza: </strong>Proporciona información útil y relevante que construye la confianza del cliente.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora el SEO: </strong>El contenido optimizado mejora la clasificación en los motores de búsqueda.</li>
                        </ul>
                    </div>
