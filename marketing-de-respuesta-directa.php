			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El marketing de respuesta directa busca provocar una respuesta inmediata del consumidor, como una llamada o una visita a una página web.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Resultados Inmediatos: </strong>Genera resultados y respuestas rápidas de los consumidores.</li>
                            <li style="margin-bottom: 10px;"><strong>Medición Eficaz: </strong>Permite medir la efectividad de las campañas en tiempo real.</li>
                            <li style="margin-bottom: 10px;"><strong>Engagement Activo: </strong>Fomenta la participación activa del consumidor con la marca.</li>
                        </ul>
                    </div>
