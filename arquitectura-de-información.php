			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">ARQUITECTURA DE 
						</h5>
                        ...
                        La arquitectura de la información se refiere a la estructuración y organización del contenido en su 
                        sitio web para que los usuarios puedan encontrar fácilmente la información que buscan.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Facilita la navegación: </strong>Estructura el contenido de manera lógica y coherente.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora la accesibilidad: </strong>Permite que los usuarios accedan rápidamente a la información relevante.</li>
                            <li style="margin-bottom: 10px;"><strong>Optimiza la experiencia del usuario: </strong>Hace que la interacción con el sitio sea más eficiente y agradable.</li>
                        </ul>
                    </div>
