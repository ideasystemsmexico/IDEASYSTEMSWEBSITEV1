			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión de almacenes permite una gestión eficiente y centralizada de todas las actividades del almacén, mejorando la eficiencia operativa y reduciendo los costos. 
                        Es esencial para mantener la competitividad y asegurar la calidad en la gestión de inventarios.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Gestión de Inventarios: </strong>Facilita la gestión y control del inventario.</li>
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos: </strong>Reduce errores y aumenta la eficiencia.</li>
                            <li style="margin-bottom: 10px;"><strong>Optimización de Espacio: </strong>Mejora la utilización del espacio del almacén.</li>
