			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un sistema de cadena de suministro permite una gestión eficiente y centralizada de todas las actividades de la cadena de suministro, desde la adquisición de materias primas hasta la entrega del producto final. 
                        Esto es crucial para mantener la eficiencia operativa y la satisfacción del cliente.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Optimización de la Cadena de Suministro: </strong>Mejora la eficiencia y reduce los costos.Mejora la eficiencia y reduce los costos.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Inventarios: </strong>Facilita la planificación y gestión del inventario.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora en la Visibilidad y Control: </strong>Proporciona visibilidad y control sobre todas las actividades de la cadena de suministro.</li>
