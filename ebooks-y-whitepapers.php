			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">EBOOKS Y
						</h5>
                        ...
                        Los eBooks y whitepapers son documentos detallados que proporcionan información profunda sobre un tema específico, utilizados para educar y generar leads.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Profundidad de Información: </strong>Ofrecen información detallada y valiosa que establece la autoridad de la marca</li>
                            <li style="margin-bottom: 10px;"><strong>Generación de Leads: </strong>Atraen a lectores interesados que pueden convertirse en leads calificados.</li>
                            <li style="margin-bottom: 10px;"><strong>Educación del Cliente: </strong>Ayudan a educar a los clientes sobre temas relevantes, mejorando la toma de decisiones.</li>
                        </ul>
                    </div>
