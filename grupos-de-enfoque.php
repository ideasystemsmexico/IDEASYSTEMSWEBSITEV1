			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Los grupos de enfoque son sesiones de discusión moderadas con un pequeño grupo de personas, utilizadas para obtener percepciones cualitativas profundas.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Perspectivas Profundas: </strong>Ofrecen una comprensión detallada de las actitudes, percepciones y motivaciones de los consumidores.</li>
                            <li style="margin-bottom: 10px;"><strong>Interacción Dinámica: </strong>Permiten explorar ideas y conceptos a través de la interacción grupal.</li>
                            <li style="margin-bottom: 10px;"><strong>Validación de Conceptos: </strong>Ayudan a validar conceptos y enfoques antes de su implementación.</li>
                        </ul>
                    </div>
