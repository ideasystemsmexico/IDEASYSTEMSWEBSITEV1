			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión para laboratorios centraliza y automatiza todas las actividades relacionadas con la gestión de laboratorios, mejorando la eficiencia y asegurando el cumplimiento normativo. 
                        Es esencial para mantener la calidad y la seguridad en la gestión de laboratorios.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            ...
                            <li style="margin-bottom: 10px;"><strong>Cumplimiento Normativo: </strong>Asegura que su laboratorio cumpla con las regulaciones vigentes.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Registros: </strong>Facilita la gestión y acceso a los registros de laboratorio.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Proporciona insights sobre el estado y rendimiento del laboratorio.</li>
                        </ul>
                    </div>
