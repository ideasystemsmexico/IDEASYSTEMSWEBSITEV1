			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">CURACIÓN DE
						</h5>
                        ...
                        La curación de contenido implica seleccionar y compartir contenido relevante de terceros con su audiencia.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Ahorro de Tiempo: </strong>Facilita la generación de contenido sin la necesidad de crear todo desde cero.</li>
                            <li style="margin-bottom: 10px;"><strong>Autoridad: </strong>Posiciona a la marca como una fuente confiable de información relevante.</li>
                            <li style="margin-bottom: 10px;"><strong>Diversidad de Contenido: </strong>Ofrece una variedad de perspectivas y recursos a la audiencia.</li>
                        </ul>
                    </div>
