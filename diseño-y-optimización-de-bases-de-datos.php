			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">DISEÑO Y OPTIMIZACIÓN DE 
						</h5>
                        ...
                        ¿Por qué debería adquirir este servicio? Una base de datos bien diseñada y optimizada es fundamental para el rendimiento y la eficiencia de sus aplicaciones. 
                        Un mal diseño puede llevar a problemas de rendimiento, pérdida de datos y dificultades de escalabilidad.
						<br>
                        Proveemos servicios de diseño y optimización de bases de datos que incluyen modelado de datos, normalización, y optimización de consultas. 
                        Nos aseguramos de que su base de datos sea robusta, eficiente y escalable.
						</p>
					...
					<div class="col-lg-6 offset-lg-1 mb-5">
						<div class="position-relative border-width-10 border-color-light clearfix border border-radius"
							...
							<?
								include('--embed-video-basesdedatos-ideasystems.php');
 							?>
