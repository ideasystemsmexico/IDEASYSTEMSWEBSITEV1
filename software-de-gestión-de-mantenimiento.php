			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión de mantenimiento permite una gestión eficiente y centralizada de todas las actividades de mantenimiento, 
                        mejorando la eficiencia y reduciendo los costos de mantenimiento. Es esencial para mantener la competitividad y asegurar la calidad del servicio.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Planificación y Programación Eficiente: </strong>Mejora la planificación y programación de tareas de mantenimiento.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Recursos: </strong>Optimiza la asignación y uso de recursos.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora en la Visibilidad y Control: </strong>Proporciona visibilidad y control sobre todas las actividades de mantenimiento.</li>
