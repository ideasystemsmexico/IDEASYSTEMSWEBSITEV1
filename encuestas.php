			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Las encuestas son una herramienta de investigación cuantitativa que recopila datos a través de preguntas estructuradas dirigidas a una muestra de la población.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Datos Cuantitativos: </strong>Proporciona datos numéricos que pueden ser analizados estadísticamente.</li>
                            <li style="margin-bottom: 10px;"><strong>Segmentación: </strong>Permite segmentar a los encuestados según diversas características demográficas y comportamentales.</li>
                            <li style="margin-bottom: 10px;"><strong>Feedback Directo: </strong>Obtiene opiniones y percepciones directas de los consumidores sobre productos y servicios.</li>
                        </ul>
                    </div>
