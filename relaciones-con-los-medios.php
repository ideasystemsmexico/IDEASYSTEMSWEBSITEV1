			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Las relaciones con los medios son fundamentales para construir y mantener relaciones positivas con periodistas y medios de comunicación.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Genera cobertura positiva: </strong>Aumenta la probabilidad de obtener cobertura mediática favorable.</li>
                            <li style="margin-bottom: 10px;"><strong>Fortalece las conexiones: </strong>Establece relaciones duraderas y beneficiosas con los medios.</li>
                            <li style="margin-bottom: 10px;"><strong>Aumenta la credibilidad: </strong>La cobertura mediática positiva puede mejorar la percepción de la marca.</li>
                        </ul>
                    </div>
