			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        La publicidad en radio es una forma efectiva de llegar a audiencias locales y específicas a través de anuncios auditivos.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Accesibilidad: </strong>Llega a los oyentes en diversos entornos y momentos del día.</li>
                            <li style="margin-bottom: 10px;"><strong>Costo-efectividad: </strong>Suele ser más económica en comparación con otros medios tradicionales.</li>
                            <li style="margin-bottom: 10px;"><strong>Segmentación regional: </strong>Permite dirigirse a audiencias locales y específicas.</li>
                        </ul>
                    </div>
