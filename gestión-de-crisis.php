			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        La gestión de crisis es crucial para mitigar los impactos negativos de situaciones imprevistas y mantener la confianza del público y los stakeholders.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Protege la reputación: </strong>Informa al público y a los medios sobre novedades y logros.</li>
                            <li style="margin-bottom: 10px;"><strong>Mantiene la confianza del cliente: </strong>Proyecta una imagen profesional y confiable.</li>
                            <li style="margin-bottom: 10px;"><strong>Prepara para lo inesperado: </strong>Puede atraer la atención de periodistas y medios.</li>
                        </ul>
                    </div>
