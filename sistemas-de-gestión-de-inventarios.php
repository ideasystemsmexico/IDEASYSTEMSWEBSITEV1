			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un sistema de gestión de inventarios permite un control preciso y en tiempo real de su inventario, evitando excesos y faltantes. 
                        Esto es fundamental para mantener la eficiencia operativa y satisfacer la demanda del cliente sin incurrir en costos innecesarios.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Control de Inventario en Tiempo Real: </strong> Mejora la visibilidad y control sobre el stock disponible.</li>
                            <li style="margin-bottom: 10px;"><strong>Reducción de Costos: </strong> Minimiza el exceso de inventario y reduce los costos de almacenamiento.</li>
                            <li style="margin-bottom: 10px;"><strong>Optimización de Reabastecimiento: </strong>Facilita la planificación de compras y reabastecimiento según la demanda.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora en la Satisfacción del Cliente: </strong>Asegura la disponibilidad de productos y mejora la experiencia del cliente.</li>
                        </ul>
                    </div>
