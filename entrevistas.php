			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Las entrevistas son conversaciones estructuradas o semiestructuradas con individuos para recopilar datos cualitativos detallados.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Profundidad de Información: </strong>Proporcionan una comprensión detallada de las opiniones y experiencias individuales.</li>
                            <li style="margin-bottom: 10px;"><strong>Flexibilidad: </strong>Permiten explorar temas en profundidad y adaptar las preguntas según las respuestas del entrevistado.</li>
                            <li style="margin-bottom: 10px;"><strong>Perspectiva Personalizada: </strong>Ofrecen una perspectiva personalizada y detallada de cada encuestado.</li>
                        </ul>
                    </div>
