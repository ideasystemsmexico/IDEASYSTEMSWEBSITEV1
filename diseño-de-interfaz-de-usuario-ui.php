			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">DISEÑO DE 
						</h5>
                        ...
                        Un diseño de interfaz de usuario (UI) efectivo asegura que los usuarios puedan interactuar de manera intuitiva y agradable con su sitio web. 
                        Esto incluye la disposición de los elementos visuales, la tipografía, los colores y los iconos, todos los cuales deben trabajar en armonía para proporcionar una experiencia coherente y atractiva.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Mejora la usabilidad: </strong>Facilita la navegación y el acceso a la información.</li>
                            <li style="margin-bottom: 10px;"><strong>Aumenta la satisfacción del usuario: </strong>Ofrece una experiencia visualmente atractiva y funcional.</li>
                            <li style="margin-bottom: 10px;"><strong>Incrementa las conversiones: </strong>Un diseño intuitivo guía a los usuarios hacia las acciones deseadas.</li>
                        </ul>
                    </div>
