			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">RESPUESTA A
						</h5>
                        ...
                        ¿Por qué debería adquirir este servicio? La respuesta rápida y efectiva a incidentes de seguridad es crucial para minimizar el 
                        impacto de las brechas de seguridad y restaurar la normalidad de sus operaciones.
						<br>
                        Ofrecemos servicios de respuesta a incidentes que incluyen la detección, contención, erradicación y recuperación de incidentes de seguridad. Nos aseguramos de que sus sistemas sean restaurados rápidamente 
                        y que se implementen medidas preventivas para evitar futuros incidentes.
                        </p>
					</div>
					<div class="col-lg-6 offset-lg-1 mb-5">
						<div class="position-relative border-width-10 border-color-light clearfix border border-radius"
							...
							<?
								include('--embed-video-ciberseguridad-ideasystems.php');
 							?>
						</div>
					</div>
