			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">MODERNIZACIÓN DE
						</h5>
                        ...
                        ¿Por qué debería adquirir este servicio? La tecnología avanza rápidamente y las aplicaciones heredadas pueden convertirse en un obstáculo para la innovación y eficiencia empresarial. 
                        La modernización de aplicaciones permite aprovechar las nuevas tecnologías para mejorar el rendimiento y reducir costos operativos.
						<br>
                        Proveemos servicios de modernización de aplicaciones que incluyen la reingeniería, migración a nuevas plataformas, y la actualización de tecnologías subyacentes. 
                        Nuestro objetivo es transformar sus aplicaciones para que sigan siendo relevantes y competitivas.
						</p>
					...
					<div class="col-lg-6 offset-lg-1 mb-5">
						<div class="position-relative border-width-10 border-color-light clearfix border border-radius"
							...
							<?
								include('--embed-video-desarrollo-ideasystems.php');
 							?>
						</div>
					</div>
