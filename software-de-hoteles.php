			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión para hoteles permite una gestión eficiente y centralizada de todas las actividades del hotel, mejorando la eficiencia operativa y la satisfacción del cliente. 
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Gestión de Reservas: </strong>Reduce errores y aumenta la eficiencia.</li>
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos: </strong>Asegura que su laboratorio cumpla con las regulaciones vigentes.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Clientes: </strong>Facilita la gestión y acceso a los registros de laboratorio.</li>
