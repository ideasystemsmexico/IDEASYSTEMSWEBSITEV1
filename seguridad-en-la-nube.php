			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SEGURIDAD EN
						</h5>
                        ...
                        ¿Por qué debería adquirir este servicio? La seguridad en la nube es crucial para proteger datos y aplicaciones alojadas en entornos de nube, 
                        asegurando que sus sistemas sean seguros y cumplan con las regulaciones.
						<br>
                        Ofrecemos servicios de seguridad en la nube que incluyen la evaluación de seguridad, implementación de medidas de protección y monitoreo continuo. 
                        Nos aseguramos de que sus entornos de nube sean seguros y protegidos contra amenazas.
                        </p>
					</div>
