			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SCADA
						</h5>
                        ...
                        SCADA en la nube permite la supervisión y control de procesos industriales desde cualquier lugar y en cualquier momento, mejorando la flexibilidad y reduciendo los costos de infraestructura. 
                        Es esencial para mantener la competitividad y adaptarse a las nuevas tecnologías.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Accesibilidad: </strong>Permite el acceso y control desde cualquier lugar y en cualquier momento.</li>
                            <li style="margin-bottom: 10px;"><strong>Reducción de Costos: </strong>Reduce los costos de infraestructura y mantenimiento.</li>
                            <li style="margin-bottom: 10px;"><strong>Escalabilidad: </strong>Permite una fácil expansión y adaptación a nuevas necesidades.</li>
                            <li style="margin-bottom: 10px;"><strong>Seguridad: </strong>Proporciona niveles avanzados de seguridad y protección de datos.</li>
                        </ul>
                    </div>
