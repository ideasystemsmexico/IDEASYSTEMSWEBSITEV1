			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un sistema de manufactura permite una gestión eficiente y automatizada de los procesos de producción, mejorando la calidad y reduciendo los costos. 
                        Es esencial para mantener la competitividad en el mercado de manufactura.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Optimización de Procesos: </strong>Mejora la eficiencia y reduce los costos de producción.</li>
                            ...
                            <li style="margin-bottom: 10px;"><strong>Gestión de Recursos: </strong>Optimiza la utilización de recursos y reduce los desperdicios.</li>
                            <li style="margin-bottom: 10px;"><strong>Visibilidad en Tiempo Real: </strong>Proporciona visibilidad y control sobre el proceso de producción.</li>
                        </ul>
                    </div>
