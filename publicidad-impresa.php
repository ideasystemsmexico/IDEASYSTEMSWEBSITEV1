			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        La publicidad impresa incluye anuncios en periódicos, revistas, folletos y otros medios impresos. 
                        Es una forma tradicional pero efectiva de llegar a audiencias específicas.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Credibilidad: </strong>Los medios impresos suelen ser percibidos como fuentes de información confiables.</li>
                            <li style="margin-bottom: 10px;"><strong>Segmentación: </strong>Permite llegar a audiencias específicas mediante publicaciones especializadas.</li>
                            <li style="margin-bottom: 10px;"><strong>Larga duración: </strong>Los anuncios impresos pueden tener una vida útil más prolongada en comparación con otros medios.</li>
                        </ul>
                    </div>
