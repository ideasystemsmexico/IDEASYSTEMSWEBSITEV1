			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Los comunicados de prensa son una herramienta fundamental para difundir información importante sobre su empresa a los medios de comunicación y al público.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Aumenta la visibilidad: </strong>Informa al público y a los medios sobre novedades y logros.</li>
                            <li style="margin-bottom: 10px;"><strong>Fortalece la imagen de la marca: </strong>Proyecta una imagen profesional y confiable.</li>
                            <li style="margin-bottom: 10px;"><strong>Genera cobertura mediática: </strong>Puede atraer la atención de periodistas y medios.</li>
                        </ul>
                    </div>
