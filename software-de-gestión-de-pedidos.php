			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SOFTWARE DE 
						</h5>
                        ...
                        El software de gestión de pedidos es una herramienta esencial para las empresas que buscan optimizar sus procesos de ventas y distribución. 
                        Este tipo de software facilita la administración de pedidos desde su recepción hasta la entrega, mejorando la eficiencia y la satisfacción del cliente.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Eficiencia en el Proceso de Venta: </strong>Automatiza y optimiza el proceso de gestión de pedidos, reduciendo errores y mejorando la eficiencia.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora la Satisfacción del Cliente: </strong>Asegura una gestión rápida y precisa de los pedidos, mejorando la experiencia del cliente.</li>
                            <li style="margin-bottom: 10px;"><strong>Visibilidad y Control: </strong>Proporciona una visión integral de todo el proceso de pedidos, desde la recepción hasta la entrega.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Optimización: </strong>Facilita el análisis de datos y la optimización de procesos mediante reportes detallados.</li>
                        </ul>
                    </div>
