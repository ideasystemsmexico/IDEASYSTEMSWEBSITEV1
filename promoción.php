			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        La promoción abarca todas las actividades que comunican las características y beneficios de sus productos a los clientes. 
                        Una estrategia de promoción bien planificada aumenta la visibilidad y genera interés en su oferta.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Aumenta la visibilidad: </strong>Mejora la visibilidad y el reconocimiento de la marca.</li>
                            <li style="margin-bottom: 10px;"><strong>Genera demanda: </strong>Estimula el interés y la demanda por los productos.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora la comunicación: </strong>Comunica claramente los beneficios y características del producto.</li>
                        </ul>
                    </div>
