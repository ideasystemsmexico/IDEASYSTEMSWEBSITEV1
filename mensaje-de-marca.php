			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El mensaje de marca es la comunicación verbal y escrita que transmite los valores, la misión y la visión de la empresa.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Claridad: </strong>Comunica claramente la propuesta de valor y los beneficios de la marca.</li>
                            <li style="margin-bottom: 10px;"><strong>Coherencia: </strong>Asegura que todos los mensajes sean coherentes y alineados con la estrategia de marca.</li>
                            <li style="margin-bottom: 10px;"><strong>onexión Emocional: </strong>Crea una conexión emocional con los clientes, mejorando la lealtad y el engagement.</li>
                        </ul>
                    </div>
