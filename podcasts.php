			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Los podcasts son programas de audio que se pueden descargar o escuchar en línea, utilizados para compartir información y entretenimiento de manera conveniente.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Accesibilidad: </strong>Permiten a la audiencia consumir contenido en cualquier momento y lugar.</li>
                            <li style="margin-bottom: 10px;"><strong>Engagement Personalizado: </strong>Fomenta una conexión personal con la audiencia a través de la voz y la narrativa.</li>
                            <li style="margin-bottom: 10px;"><strong>Expansión de Audiencia: </strong>Atrae a nuevas audiencias que prefieren el contenido de audio sobre otros formatos.</li>
                        </ul>
                    </div>
