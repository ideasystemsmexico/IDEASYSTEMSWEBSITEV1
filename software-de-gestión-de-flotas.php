			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión de flota permite una gestión eficiente y centralizada de todos los vehículos de su flota, mejorando la eficiencia operativa y reduciendo los costos. 
                        Es esencial para mantener la competitividad y asegurar la calidad del servicio.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Monitoreo en Tiempo Real: </strong>Proporciona visibilidad y control sobre todos los vehículos de la flota.</li>
                            <li style="margin-bottom: 10px;"><strong>Optimización de Rutas: </strong>Mejora la eficiencia y reduce los costos de combustible y mantenimiento.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Mantenimiento: </strong>Facilita la planificación y gestión del mantenimiento de los vehículos.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Proporciona insights sobre el rendimiento de la flota y permite la toma de decisiones informadas.</li>
                        </ul>
                    </div>
