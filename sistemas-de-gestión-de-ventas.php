			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un sistema de gestión de ventas optimiza y automatiza el proceso de ventas, mejorando la eficiencia del equipo de ventas y aumentando la conversión de leads a clientes. 
                        Es crucial para maximizar los ingresos y gestionar las relaciones con los clientes de manera efectiva.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos:</strong> Reducción de tareas administrativas y mejora en la productividad del equipo de ventas.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión del Pipeline de Ventas:</strong> Seguimiento detallado de todas las oportunidades de ventas y su progreso.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis de Desempeño:</strong> Obtención de informes detallados sobre el desempeño del equipo de ventas y las tendencias de ventas.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora en la Conversión de Leads:</strong> Identificación y priorización de las mejores oportunidades de ventas.</li>
                        </ul>
                    </div>
