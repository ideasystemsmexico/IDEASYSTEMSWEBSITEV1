			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión de proyectos facilita la planificación, ejecución y seguimiento de proyectos, asegurando que se completen a tiempo y dentro del presupuesto. 
                        Esto es crucial para mantener la eficiencia y la calidad en la entrega de proyectos.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            ...
                            <li style="margin-bottom: 10px;"><strong>Gestión de Recursos: </strong>Optimiza la asignación y uso de recursos y materiales.</li>
