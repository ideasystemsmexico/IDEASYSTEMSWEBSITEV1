			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SOFTWARE DE GESTIÓN DE RECURSOS
						</h5>
                        ...
                        El software de gestión de recursos educativos digitales es una herramienta esencial para instituciones educativas 
                        y empresas que ofrecen formación. Facilita la creación, administración y distribución de contenido educativo digital.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Accesibilidad: </strong>Permite el acceso a recursos educativos digitales desde cualquier lugar y en cualquier momento.</li>
                            <li style="margin-bottom: 10px;"><strong>Eficiencia en la Gestión de Contenidos: </strong>Facilita la creación y administración de contenido educativo, optimizando los procesos educativos.</li>
                            <li style="margin-bottom: 10px;"><strong>Mejora de la Experiencia del Estudiante: </strong>Proporciona una experiencia de aprendizaje más interactiva y personalizada.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Ofrece análisis detallados sobre el desempeño de los estudiantes y la efectividad de los recursos educativos.</li>
                        </ul>
                    </div>
