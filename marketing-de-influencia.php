			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El marketing de influencia utiliza personas influyentes para promover su marca, aprovechando su alcance y credibilidad.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Aumenta la credibilidad: </strong>Los influencers aportan credibilidad y confianza.</li>
                            <li style="margin-bottom: 10px;"><strong>Expande el alcance: </strong>Llega a nuevas audiencias a través de los seguidores de los influencers.</li>
                            <li style="margin-bottom: 10px;"><strong>Fomenta el engagement: </strong>Los influencers pueden generar un alto nivel de interacción y participación.</li>
                        </ul>
                    </div>
