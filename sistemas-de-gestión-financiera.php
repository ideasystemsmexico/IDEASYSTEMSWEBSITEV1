			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
						...
						<h5 class="text-primary font-weight-bold mb-1 custom-letter-spacing-1">SISTEMAS DE
						</h5>
                        ...
                        Un sistema de gestión financiera robusto es esencial para manejar las finanzas de su empresa de manera eficiente, asegurando precisión y cumplimiento normativo. 
                        Permite una mejor planificación financiera, control de costos y gestión de flujo de caja, lo que es fundamental para la sostenibilidad y crecimiento de su negocio.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos Financieros:</strong> Reduce errores y tiempo en tareas repetitivas.</li>
                            <li style="margin-bottom: 10px;"><strong>Cumplimiento Normativo:</strong> Asegura que su empresa cumpla con las regulaciones financieras vigentes.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión Eficiente del Flujo de Caja:</strong> Mejora la visibilidad y control de sus finanzas.</li>
                            <li style="margin-bottom: 10px;"><strong>Informes Financieros en Tiempo Real:</strong> Obtenga una visión clara y precisa del estado financiero de su empresa en cualquier momento.</li>
                        </ul>
                    </div>
