			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        La estrategia de marca define como una empresa se posiciona en el mercado y se diferencia de sus competidores.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Posicionamiento Claro: </strong>Define una propuesta de valor única y distintiva en el mercado.</li>
                            <li style="margin-bottom: 10px;"><strong>Consistencia: </strong>Asegura una comunicación coherente en todos los puntos de contacto con el cliente.</li>
                            <li style="margin-bottom: 10px;"><strong>Lealtad del Cliente: </strong>Fomenta una relación emocional con los clientes, promoviendo la lealtad a la marca.</li>
                        </ul>
                    </div>
