			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        El marketing en redes sociales utiliza plataformas como Facebook, Instagram, Twitter y LinkedIn para promocionar su marca y conectarse con su audiencia.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Interacción directa: </strong>Facilita la comunicación y el engagement con los clientes.</li>
                            <li style="margin-bottom: 10px;"><strong>Segmentación precisa: </strong>Permite dirigir mensajes a públicos específicos.</li>
                            <li style="margin-bottom: 10px;"><strong>Contenido viral: </strong>Oportunidad de que el contenido sea compartido y alcance a más personas.</li>
                        </ul>
                    </div>
