			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Un software de gestión para servicios de campo centraliza y automatiza todas las actividades relacionadas con la gestión de servicios de campo, mejorando la eficiencia operativa y la satisfacción del cliente. 
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Gestión de Órdenes de Trabajo: </strong>Facilita la gestión y seguimiento de órdenes de trabajo.</li>
                            <li style="margin-bottom: 10px;"><strong>Automatización de Procesos: </strong>Reduce errores y aumenta la eficiencia.</li>
                            <li style="margin-bottom: 10px;"><strong>Gestión de Recursos y Personal: </strong>Optimiza la asignación y uso de recursos y personal.</li>
                            <li style="margin-bottom: 10px;"><strong>Análisis y Reportes: </strong>Proporciona insights sobre el rendimiento de los servicios de campo y la satisfacción del cliente.</li>
                        </ul>
                    </div>
