			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        La publicidad en televisión sigue siendo una forma poderosa de llegar a una audiencia masiva, 
                        con un impacto significativo en la percepción y el reconocimiento de la marca.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Amplio alcance: </strong>Llega a una audiencia muy amplia y diversa.</li>
                            <li style="margin-bottom: 10px;"><strong>Impacto visual y auditivo: </strong>Combina elementos visuales y sonoros para crear un impacto duradero.</li>
                            <li style="margin-bottom: 10px;"><strong>Genera notoriedad: </strong>Puede aumentar significativamente el reconocimiento de la marca.</li>
                        </ul>
                    </div>
