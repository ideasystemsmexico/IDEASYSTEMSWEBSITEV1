			...
			<div class="container pt-5 mt-5">
				<div class="row custom-header-min-height-1 align-items-center pt-3" style="padding: 10px;backdrop-filter: blur(5px);border-radius: 15px;">
					<div class="col-lg-5 mb-5"
                        ...
                        Las infografías son representaciones visuales de información y datos que facilitan la comprensión y el aprendizaje.
                        </p>
                        ...
                        <ul class="custom-font-size-1 pt-2" style="text-align: justify;">
                            <li style="margin-bottom: 10px;"><strong>Visualmente Atractivas: </strong>Capturan la atención del público con diseños atractivos y fáciles de entender.</li>
                            <li style="margin-bottom: 10px;"><strong>Compartibilidad: </strong>Son altamente compartibles en redes sociales y otros medios.</li>
                            <li style="margin-bottom: 10px;"><strong>Educativas: </strong>Facilitan la comprensión de información compleja de manera visual y resumida.</li>
                        </ul>
                    </div>
